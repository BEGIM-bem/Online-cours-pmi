...
function Mat3() {
    ...
    return (
        <div className={styles.Python} >
            <h1 className={styles.title}>Дискретная математика  </h1>


            <p className={styles.text}> Дискре́тная матема́тика — часть математики, изучающая дискретные математические структуры, такие как графы и утверждения в логике  </p>
