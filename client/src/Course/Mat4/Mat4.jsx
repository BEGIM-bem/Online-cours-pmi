...
function Mat4() {
    ...
    return (
        <div className={styles.Python} >
            <h1 className={styles.title}>Дифференциальное уравнение </h1>


            <p className={styles.text}> Дифференциа́льное уравне́ние — уравнение, в которое входят производные функции и могут входить сама функция, независимая переменная и параметры. Порядок входящих в уравнение производных может быть различен  </p>
