...
function Androids() {
    ...
    return (
        <div className={styles.Python} >
            <h1 className={styles.title}>Android-разработка </h1>


            <p className={styles.text}>Это бесплатный видеокурс по программированию Android-приложений. Вы познакомитесь с основами Android-разработки и сделаете своё первое приложение — зашифрованный мессенджер.   </p>
